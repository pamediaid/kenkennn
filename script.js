...
function drawText() {
    ...
    if(frameNumber > 2000 && frameNumber < 2250){
        ...
        if (window.innerWidth < 600) {
            ...
            context.fillText("You're My Home, You're My Safe Place Thank You For Coming Into My Life", canvas.width/2, canvas.height/2);
        }
        opacity = opacity + 0.01;
    }
    ...
    if(frameNumber > 2500 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            ...
            context.fillText("I love you so much ken, yes you ! all the time and space in the universe can contain", canvas.width/2, canvas.height/2);
        }
        opacity = opacity + 0.01;
    }
